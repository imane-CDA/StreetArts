...
extension Art {
    ...
    static let mocks = [
        ...
        Art(
            ...
            condition: .excellent,
            date: Date(),
            authorName: "Jef Aérosol",
            authorUserName: "jefaerosol",
